 ...
 * @author Izzat Fauzan
 */
public class GuiListSave extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GuiListSave.class.getName());
    private final DefaultListModel<String> dlm = new DefaultListModel<>();
    private final List<String> items = new ArrayList<>();
    private final String[] datas = {"buku", "meja", "kursi", "tas", "pintu"};

    /**
     * Creates new form GuiListCrud
     */
    public GuiListSave() {
        initComponents();
        jListItem.setModel(dlm);
        jButtonUpdate.setText("Save Data");
        jButtonInsert.addActionListener(evt -> insertData());
        jButtonAdd.addActionListener(evt -> {
            addItem(JTextFieldItem.getText());
            JTextFieldItem.setText("");
        });
        jButtonUpdate.addActionListener(evt -> saveData());
        jButtonDelete.addActionListener(evt -> deleteItem());
        jButtonClearAll.addActionListener(evt -> clearAll());
    ...
    private void updateJumDataTersimpan() {
        setTitle("Data tersimpan = " + items.size());
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new GuiListSave().setVisible(true));
    }
